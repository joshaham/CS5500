...
//		assertTrue("MSE: "+Audio.calculateMSE(rimsky, rimsky2),Assignment6.isMatch(rimsky, rimsky2));
//		
//		Audio sons = Audio.getInstance("examples/sons.wav");
//		Audio sons2 = Audio.getInstance("examples/sons2.wav");
//		assertTrue("MSE: "+Audio.calculateMSE(sons, sons2),Assignment6.isMatch(sons, sons2));
	}
//	@Test
