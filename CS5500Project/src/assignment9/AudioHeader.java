...
public class AudioHeader {
   ...
   public static AudioHeader 
      getInstance(String fileName, byte[] bytes, int datasize) {
      String format = "";
      int nc = 0;
      int sampleRate;
      int bps;
      ...
      if (byteBuffer.get(8) != 87 || byteBuffer.get(9) != 65 ||
         ...
         if (Assignment9.DEBUG) { 
            System.err.print("ERROR: NOT Wave Format" + "  ");
         }
         return null;
      }
      ...
      if (byteBuffer.get(20) != 1 || byteBuffer.get(21) != 0) {
         if (Assignment9.DEBUG) {
            System.err.print("ERROR: NOT PCM" + "  ");
         }
         return null;
      }
      ...
      if (byteBuffer.get(22) == 2 && byteBuffer.get(23) == 0) {
         ...
         if(Assignment9.DEBUG){System.err.print(
      ...
      return new AudioHeader(fileName, format, nc,
                              sampleRate, bps, audioLength);
   }
